...
if ( ! class_exists( 'WLFMC_Session' ) ) {
	...
	class WLFMC_Session {
		...
		public function set_session_cookie() {
			...
			wlfmc_setcookie( $this->get_session_cookie_name(), $cookie_value, $this->_session_expiration, $this->use_secure_cookie(), true );
		...
		public function get_session_cookie_name() {
			if ( empty( $this->_cookie_name ) ) {
				$this->_cookie_name = apply_filters( 'wlfmc_session_cookie', 'wlfmc_session_' . COOKIEHASH );
			}
		...
		public function set_session_expiration() {
			$this->_session_expiring   = time() + wlfmc_get_cookie_expiration() - HOUR_IN_SECONDS;
			$this->_session_expiration = time() + wlfmc_get_cookie_expiration();
		}
