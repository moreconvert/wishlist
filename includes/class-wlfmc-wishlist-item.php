...
if ( ! class_exists( 'WLFMC_Wishlist_Item' ) ) {
	...
	class WLFMC_Wishlist_Item extends WC_Data implements ArrayAccess {
		...
		public function get_formatted_product_price( $context = 'view' ) {
			...
			$formatted_price = $base_price ? $product->get_price_html() : apply_filters( 'wlfmc_free_text', __( 'Free!', 'wc-wlfmc-wishlist' ), $product );

			return apply_filters( 'wlfmc_item_formatted_price', $formatted_price, $base_price, $product );
		}
