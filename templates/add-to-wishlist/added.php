...
<div class="wlfmc-wishlistaddedbrowse" data-original-product-id="<?php echo esc_attr( $parent_product_id ); ?>" data-product-id="<?php echo esc_attr( $product_id ); ?>">
	<span class="feedback">
		<?php echo wp_kses_post( $icon ); ?>
		<?php if ( '' !== $product_added_text ) : ?>
			<span><?php echo wp_kses_post( $product_added_text ); ?></span>
		<?php endif; ?>
	</span>
</div>
