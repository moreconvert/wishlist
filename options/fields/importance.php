	...
	<table class="mct-border-table" data-repeater-list="<?php echo esc_attr( $name ); ?>">
			...
			<?php foreach ( $value as $k => $row ) : ?>
				<tr data-repeater-item>
					...
					<td data-title="<?php esc_attr_e( 'Slug', 'mct-options' ); ?>">
						<input class="" name="<?php echo esc_attr( $name ); ?>[<?php echo esc_attr( $k ); ?>][slug]" value="<?php echo esc_attr( $row['slug'] ); ?>" type="text"/>
					</td>
		...
		<?php else : ?>
			<tr data-repeater-item>
				...
				<td data-title="<?php esc_attr_e( 'Slug', 'mct-options' ); ?>">
					<input class="" name="<?php echo esc_attr( $name ); ?>[][slug]" type="text"/>
				</td>
				<td data-title="<?php esc_attr_e( 'Action', 'mct-options' ); ?>">
					<a data-repeater-delete href="#!"><span class="dashicons dashicons-dismiss"></span></a>
				</td>
