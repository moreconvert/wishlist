...
<input type="text" data-alpha-enabled="true" id="<?php echo esc_attr( $field_id ); ?>" name="<?php echo esc_attr( $name ); ?>" class="mct-color-picker <?php echo esc_attr( $class ); ?>" value="<?php echo esc_attr( $value ); ?>"
